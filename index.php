...
<body>
	...
	<div class="container" id="main-content">
		...
		<p>En stack fungerar engligt LIFO (Last in First out) principen. 
            Det betyder att det senaste elementet som läggs
		...
		<ul class="list-unstyled">
			<li class="media">
				...
				<div class="media-body">
					...
					<p>Push operationen lägger ett element först i stacken (längst upp)</p>
				</div>
			</li>
			<li class="media my-4">
			...
			<li class="media">
				...
				<div class="media-body">
					...
					<p>Tittar på det översta elementet i stacken</p>
				</div>
			</li>
		</ul>
	</div>
